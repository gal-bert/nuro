...
//  Nuro
//
//  Created by Gregorius Albert on 03/10/22.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.standard.integer(forKey: UserDefaultsHelper.Keys.lastWeekdayId) != Date().getCurrentWeekday() {
            ...
            // TODO: Mirror data
            // 1. Query from routineHeader to array
            // 2. Loop array and insert to mirrorHeader
            // 3. When getting `mirrorDetail`
        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Nuro")
