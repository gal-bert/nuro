...
class TextAttachments {
    ...
    static func leadingAttachment(imageName: String, text: String, imageHeight: CGFloat = 30.0, yOffset: CGFloat = -3) -> NSMutableAttributedString {
        
        let imageAttachment = getAttachment(imageName: imageName, imageHeight: imageHeight, yOffset: yOffset)
    ...
    static func trailingAttachment(text: String, imageName: String, imageHeight: CGFloat = 30.0, yOffset: CGFloat = -3) -> NSMutableAttributedString {
